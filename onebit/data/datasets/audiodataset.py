...
class AudioDataset(BaseDataset):
    ...
    def __init__(self,
        ...
        self.norm = getattr(self.data_conf.dataset, 'norm', True) 
        self.trim_sil = getattr(self.data_conf.dataset, 'trim_sil', True)
        logger.info(f'Norm: {self.norm}, trim_sil: {self.trim_sil}')
    ...
    def _load_audio(self, audio_path: str):
        #do_norm = self.data_conf.dataset.get('do_norm', True)
        #do_trim_sil = self.data_conf.dataset.get('trim_sil', True)
        audio, sr = audio_util.get_audio(audio_path,
                                to_mono = True,
                                norm=self.norm,
                                trim_sil=self.trim_sil)
